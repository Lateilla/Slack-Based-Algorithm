...
/***********************       collect user info         **********************************/
    ...
    char semester[7], timeslots[10], student[10], studentFile[20], force[5];
    FILE *fp;
  ...
  /*  printf("\t\t\t\t\t\t   Welcome!\n\n\n"
    ...
    printf("Please enter 'New' if you are a new student (1st Year, 1st Semester), otherwise please enter 'Current'.\n");
    printf("\nAre you a new student or an current student?: ");
    scanf("%s", student);
    while(strcasecmp(student, "New") != 0 && strcasecmp(student, "Current") != 0)
    {
        printf("\nError: Please enter 'New' or 'Current': ");
        scanf("%s", student);
    }
    ...
    else if(strcasecmp(student, "Current") == 0)
    {
        printf("\nStudent ID: ");
        scanf("%s", studentFile);
    ...
    if(strcasecmp(student, "Current") == 0)
    {
